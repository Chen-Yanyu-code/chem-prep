...
const UNKNOWNS = [
  {
    ...
    reactions: {
      ...
      "加入AgNO₃溶液": "无明显沉淀（OH⁻与Ag⁺量少时现象不明显）。",
      "加入BaCl₂溶液": "无明显现象。",
      "加入CuSO₄溶液": "生成蓝色沉淀。",
      "加入FeCl₃溶液": "生成红褐色沉淀。",
      "加入CO₂气体": "溶液变浑浊，若继续通入足量CO₂则沉淀重新溶解变澄清。",
      "加入Na₂CO₃溶液": "无明显现象。",
      "加水溶解后测pH": "pH > 7，强碱性，pH约12~14。",
      "观察外观": "白色固体，颗粒状或片状。暴露在空气中容易潮解，表面变湿。"
    },
  ...
  },
  {
    ...
    icon: "⬜",
    reactions: {
      "加热": "加热不分解（区别于NaHCO₃，这是两者的重要区别）。",
      "加入稀盐酸": "产生大量气泡，气体能使澄清石灰水变浑浊。",
      "加入稀硫酸": "产生大量气泡，气体能使澄清石灰水变浑浊。",
      "加入石蕊溶液": "溶液变蓝色，Na₂CO₃溶液呈碱性。",
      "加入酚酞溶液": "溶液变红色，Na₂CO₃溶液呈碱性。",
      "加入AgNO₃溶液": "生成白色沉淀，加稀HNO₃后沉淀溶解并产生气泡（区别于AgCl不溶于稀HNO₃）。",
      "加入BaCl₂溶液": "生成白色沉淀，加入稀盐酸后沉淀溶解并产生气泡（区别于BaSO₄不溶于稀盐酸）。",
      "加入CuSO₄溶液": "生成蓝绿色沉淀。",
      "加入FeCl₃溶液": "生成红褐色沉淀。",
      "加入CO₂气体": "无明显现象（CO₂过量时生成NaHCO₃，现象不明显）。",
      "加入Na₂CO₃溶液": "——（无法与自身反应）",
  ...
  },
  {
    ...
    icon: "⬜",
    reactions: {
      "加热": "加热分解，产生CO₂和H₂O，试管口出现水雾，气体使澄清石灰水变浑浊。这是与Na₂CO₃的重要区别！",
      "加入稀盐酸": "立即产生大量气泡（比Na₂CO₃反应更剧烈），气体使澄清石灰水变浑浊。",
      "加入稀硫酸": "立即产生大量气泡，气体使澄清石灰水变浑浊。",
      "加入石蕊溶液": "溶液变蓝色（碱性，但碱性弱于Na₂CO₃）。",
      "加入酚酞溶液": "溶液变浅红色（碱性较弱）。",
      "加入AgNO₃溶液": "生成淡黄色沉淀，不稳定，很快变为白色沉淀。",
      "加入BaCl₂溶液": "无沉淀（这是与Na₂CO₃的区别！Na₂CO₃与BaCl₂会生成白色沉淀，而NaHCO₃不会）。",
      "加入CuSO₄溶液": "产生蓝色沉淀，同时有气泡产生。",
      "加入FeCl₃溶液": "产生红褐色沉淀，同时有气泡（CO₂）。",
  ...
  },
  {
    ...
    icon: "🔵",
    reactions: {
      "加热": "蒸干后得到蓝色硫酸铜晶体，再强热则变为白色无水CuSO₄，高温继续分解得到黑色固体（CuO）。",
      "加入稀盐酸": "无明显现象，溶液仍呈蓝色。",
      "加入稀硫酸": "无明显现象。",
      "加入石蕊溶液": "溶液变红（CuSO₄溶液水解，呈弱酸性）。",
      "加入酚酞溶液": "无变色（溶液呈酸性，酚酞无色）。",
      "加入AgNO₃溶液": "无明显现象。",
      "加入BaCl₂溶液": "生成白色沉淀，该沉淀不溶于稀硝酸。",
      "加入NaOH溶液": "生成蓝色沉淀，加热后蓝色沉淀变为黑色。",
      "加入铁粉": "蓝色溶液逐渐褪色变为浅绿色，铁粉表面出现红色固体。",
      "加入锌片": "锌片表面出现红色固体，溶液蓝色逐渐褪去变为无色。",
      "加入Na₂CO₃溶液": "生成蓝绿色沉淀，有气泡。",
      "加水溶解后测pH": "pH < 7，溶液呈弱酸性（Cu²⁺水解）。",
      "观察外观": "蓝色透明溶液（无水CuSO₄为白色粉末，遇水变蓝）。"
    },
  ...
  },
  {
    ...
    reactions: {
      ...
      "加入NaOH溶液": "无明显现象（可用指示剂辅助判断，中和反应放热）。",
      "加入Na₂CO₃溶液": "产生大量气泡，气体能使澄清石灰水变浑浊。",
      "加入NaHCO₃": "立即产生大量气泡，气体能使澄清石灰水变浑浊。",
      "加入AgNO₃溶液": "产生白色沉淀，该沉淀不溶于稀硝酸！这是鉴别Cl⁻的标准方法。",
      "加入BaCl₂溶液": "无明显现象（Cl⁻与Ba²⁺不反应）。",
      "加入铁片": "铁片逐渐溶解，产生气泡，溶液变浅绿色。",
      "加入锌片": "锌片溶解，产生大量气泡。",
      "加入铜片": "无明显现象（Cu不与稀盐酸反应）。",
      "加入大理石": "大理石溶解，产生气泡，气体使澄清石灰水变浑浊。",
      "加水溶解后测pH": "pH < 7，酸性，稀盐酸pH约2~4。",
      "观察外观": "无色透明溶液，浓盐酸在空气中有白雾（HCl挥发与水蒸气结合形成）。"
    },
  ...
  },
  {
    ...
    reactions: {
      ...
      "加入AgNO₃溶液": "不反应，固体不溶解。",
      "加入BaCl₂溶液": "不反应。",
      "加入CO（一氧化碳，加热）": "被CO还原，高温下固体逐渐由红棕色变为黑色，导出气体通入石灰水变浑浊。",
      "加入H₂（加热）": "被H₂还原，加热后固体逐渐由红棕色变为银白色，试管口出现水雾。",
      "加入铝粉（铝热反应）": "铝热反应（需点燃），放出大量热，发出耀眼白光，熔融状态。",
      "加入KSCN溶液": "Fe₂O₃溶于稀酸后得到黄色溶液，加KSCN变血红色（证明含Fe³⁺）。",
      "加水溶解后测pH": "几乎不溶于水，pH约为7（中性）。",
      "观察外观": "红棕色粉末，是最明显的外观特征（铁锈颜色）。"
    },
  ...
  },
  {
    ...
    icon: "💧",
    reactions: {
      "加热": "加热石灰水，溶解度降低，析出白色固体，碱性减弱（注意Ca(OH)₂溶解度随温度升高而减小）。",
      "加入稀盐酸": "无明显现象（可用指示剂辅助判断）。",
      "加入稀硫酸": "生成白色沉淀（CaSO₄微溶）。",
      "加入石蕊溶液": "溶液变蓝色（碱性）。",
      "加入酚酞溶液": "溶液变红色（碱性）。",
      "加入AgNO₃溶液": "无明显现象。",
      "加入BaCl₂溶液": "无明显现象。",
      "加入Na₂CO₃溶液": "生成白色沉淀。",
      "通入CO₂气体": "溶液变浑浊（白色沉淀）。继续通入过量CO₂，白色沉淀溶解，溶液重新变澄清。这是检验CO₂的标准方法！",
      "通入HCl气体": "溶液逐渐变浑浊（量多后恢复澄清）。",
      "加入FeCl₃溶液": "生成红褐色沉淀。",
      "加入CuSO₄溶液": "生成蓝色沉淀，同时有白色沉淀。",
  ...
  },
  {
    ...
    icon: "💧",
    reactions: {
      "加热": "加热分解（但较慢），产生气泡，气体使带火星木条复燃。",
      "加入MnO₂（二氧化锰）": "立即产生大量气泡！气体使带火星木条复燃。这是实验室常温制O₂的常用方法！",
      "加入Fe（铁粉）": "铁粉加速分解，产生气泡。",
  ...
  },
  {
    ...
    icon: "🟣",
    reactions: {
      "加热": "加热分解，产生气体（带火星木条复燃），固体逐渐变黑。这是实验室加热法制O₂！",
      "加入稀盐酸": "紫色溶液褪色（KMnO₄强氧化性将Cl⁻氧化）。",
      "加入稀硫酸": "溶液紫色在稀酸中较稳定，浓H₂SO₄下紫色褪去。",
      "加入石蕊溶液": "溶液呈酸性，且KMnO₄氧化性强，会使石蕊褪色。",
      "加入酚酞溶液": "无变色（酸性溶液）。",
      "加入H₂O₂溶液": "紫色逐渐褪去。",
      "加入Na₂SO₃溶液": "紫色褪去。",
      "加入乙醇（酒精）": "紫色褪去，溶液变橙黄色。",
      "加入FeSO₄溶液": "紫色褪去，溶液变黄色。",
  ...
  },
  {
    ...
    reactions: {
      ...
      "加入酚酞溶液": "无变色（中性）。",
      "加入AgNO₃溶液": "无白色沉淀（无Cl⁻）。",
      "加入BaCl₂溶液": "立即产生白色沉淀，该沉淀不溶于稀硝酸！这是检验SO₄²⁻的标准方法！",
      "加入NaOH溶液": "无明显现象。",
      "加入BaCl₂+稀HNO₃": "白色沉淀不溶于稀硝酸（确认含SO₄²⁻）。",
